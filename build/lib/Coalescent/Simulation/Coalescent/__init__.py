...
class EmbeddedGeneForest(object):
    ...
    def maximal_gene_lineages(self, s_clade=None):
        """ Given a population (specified by a node of the species tree), s_clade, (default: root of the tree), return the maximal clades of the gene tree which are embedded at or below that population """
