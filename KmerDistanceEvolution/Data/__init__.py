...
class HuelsenbeckTreeEstimateSet(Base):
    __tablename__ = 'huelsenbeck_tree_estimate_sets'
    id = Column(Integer, primary_key=True)
    ...
    #huelsenbeck_tree_estimates = relationship("HuelsenbeckTreeEstimate", back_populates="tree_estimate_set", lazy='joined')
    huelsenbeck_tree_estimates = relationship("HuelsenbeckTreeEstimate", back_populates="tree_estimate_set")
...
class HuelsenbeckTreeEstimate(Base):
    __tablename__ = 'huelsenbeck_tree_estimates'
    id = Column(Integer, primary_key=True)
    tree_estimate_set_id = Column(Integer, ForeignKey('huelsenbeck_tree_estimate_sets.id'))
    tree_estimate_id = Column(Integer, ForeignKey('tree_estimates.id'))
    ...
    #tree_estimate = relationship("TreeEstimate", lazy='joined')
    tree_estimate = relationship("TreeEstimate")
    #tree_estimate_set = relationship("HuelsenbeckTreeEstimateSet", back_populates="huelsenbeck_tree_estimates", lazy='joined')
    tree_estimate_set = relationship("HuelsenbeckTreeEstimateSet", back_populates="huelsenbeck_tree_estimates")
...
class TreeEstimate(Base):
    __tablename__ = 'tree_estimates'
    id = Column(Integer, primary_key=True)
